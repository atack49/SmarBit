...
// Server component: receives searchParams during static export
export default async function TermsPage({ searchParams }: { searchParams?: any }) {
  // Next.js may provide a promise-like searchParams in some cases; await to be safe
  const params = await searchParams;
  const initialTab = (params && params.tab === 'privacy') ? 'privacy' : 'terms';
  return <TermsClient initialTab={initialTab as 'terms' | 'privacy'} legalContent={legalContent} />;
}
